...
import { ClipboardList, Users, FileText, LogOut } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Headteacher Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => navigate('/exams')}>
          <CardHeader>
            ...
            <CardDescription>Create and oversee examinations</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => navigate('/students')}>
          <CardHeader>
            ...
            <CardDescription>Access all student information</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => navigate('/results')}>
          <CardHeader>
            ...
            <CardDescription>Review and approve results</CardDescription>
          </CardHeader>
          <CardContent>
